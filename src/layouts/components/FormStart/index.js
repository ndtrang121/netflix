...
function FormStart({ id }) {
    ...
    return (
        <div className={cx('form-wrapper')}>
            <h3 className={cx('form-title')}>Ready to watch? Enter your email to create or restart your membership.</h3>
            <form className={cx('form')} onSubmit={handleSubmit}>
                ...
                <Button className={cx('submit')} rightIcon={<FontAwesomeIcon icon={faAngleRight} />}>
                    Get Started
                </Button>
            </form>
        </div>
